...
def build_terminal():
    ...
    sections = [
        ("----------------------------------------------------", "#30363d", 122),
        ("Name:  Vaishnavi Chandore",                           "#e6edf3", 140),
        ("Role:  AI & Computer Vision Engineer",                        "#00ffcc", 158),
        ("Stack: Python, TensorFlow, PyTorch ", "#8b949e", 176),
        ("AI  Open Source  Backend  Cloud",                    "#8b949e", 194),
        ("GitHub:  40 repositories",                          "#8b949e", 212),
        ("Stars:   4+",                                      "#febc2e", 230),
        ("Focus:   Building modern ai systems",           "#39d353", 248),
        ("----------------------------------------------------", "#30363d", 266),
    ]
